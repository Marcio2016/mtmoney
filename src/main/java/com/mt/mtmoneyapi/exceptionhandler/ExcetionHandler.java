package com.mt.mtmoneyapi.exceptionhandler;
...
public class ExcetionHandler extends ResponseEntityExceptionHandler {
    ...
    /*Cria uma lista de erros das entidades através do bean validation*/
    /*BindingResult onde se encontra todos os erros do bean Validation*/
